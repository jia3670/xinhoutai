...
var CQData = [
    ...
    [{name:'重庆'}, {name:'无锡',value:100}],
    [{name:'重庆'}, {name:'哈尔滨',value:100}],
    [{name:'重庆'}, {name:'乌鲁木齐',value:100}],
    [{name:'重庆'}, {name:'青岛',value:100}],
];
...
var color = ['#a6c84c', '#ffa022', '#46bee9','green'];//航线的颜色
var series = [];
[['西安', XAData], ['西宁', XNData], ['银川', YCData], ['郑州', ZZData], ['重庆', CQData]].forEach(function (item, i) {  
    series.push({
        name: item[0] + ' Top3',
        type: 'lines',
        zlevel: 1,
